...
class ServerManageView(View):
    ...
    async def start_callback(self, interaction, button):
        await self.chester_bot.game_server_connector.restart_server()
    ...
    async def soft_restart_callback(self, interaction, button):
        await self.chester_bot.game_server_connector.soft_restart_server()
    ...
    async def stop_callback(self, interaction, button):
        await self.chester_bot.game_server_connector.stop_server()
    ...
    async def soft_stop_callback(self, interaction, button):
        await self.chester_bot.game_server_connector.soft_stop_server()
    ...
    async def soft_world_regenerate_callback(self, interaction, button):
        await self.chester_bot.game_server_connector.soft_world_regenerate()
